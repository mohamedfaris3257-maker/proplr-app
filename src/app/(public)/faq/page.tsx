...
export default async function FaqPage() {
  ...
  const STATIC_FAQS: { category: string; items: { q: string; a: string }[] }[] = [
    ...
    },
    {
      ...
      items: [
        { q: 'How much does it cost?', a: 'Foundation is AED 400/month for 8 months (AED 3,200/year). Impact is AED 999 flat for the year. Compass is a separate standalone product — see the Compass page for pricing.' },
        { q: 'Can I pay monthly?', a: 'Yes. Foundation can be paid monthly (AED 400/month) or as an upfront annual payment.' },
